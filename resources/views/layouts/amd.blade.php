        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Vistas:</h6>
                        <a class="collapse-item" href="{{ asset(route('purchases.index')) }}">Comprar</a>
                        <a class="collapse-item" href="{{ asset(route('comprar.index')) }}">Comprando</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <b>.  </b><img class=" rounded-circle" width="70px;" height="60px;"
                                    src=" {{ asset('image/descarga(33).JPEG') }} ">
                            </a>
